          ...
          <div className="flex size-full flex-col items-center justify-center gap-2 px-[22px] text-center">
            ...
            <div className="mt-0.5 flex items-center gap-2">
              <button
                ...
                className="text-label rounded-sm px-2 py-1 text-gray-300 underline underline-offset-2 transition-colors hover:text-gray-100 disabled:cursor-not-allowed disabled:text-gray-600"
              >
                다시 선택
              </button>
              <button
