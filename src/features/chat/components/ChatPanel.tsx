  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div
        ...
        // scrollbar-dark: 어두운 패널이라 전역 기본 썸(gray-400)은 너무 밝게 뜬다.
        className="scrollbar-dark relative flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-contain px-7 pt-8 pb-4"
      >
        {chatQuery.isPending ? (
