  ...
  return (
    ...
    <div ref={rootRef} className="relative shrink-0">
      <button
        ...
        className="text-label flex h-7 items-center gap-1 rounded-md border-[0.5px] border-gray-500 pr-2 pl-2.5 font-medium text-gray-700 transition-colors hover:border-gray-600 hover:text-gray-900"
      >
        {SORT_LABEL[value]}
            ...
            <li key={option}>
              <button
                ...
                className={cn(
                  ...
                  option === value ? 'text-gray-900' : 'text-gray-700',
                )}
              >
                {SORT_LABEL[option]}
              </button>
