  ...
  return (
    <section className="mt-12">
      <div className="mb-4 flex flex-wrap items-baseline gap-2">
        ...
        <span className="text-label text-gray-650">
          이 과목을 함께 듣는 친구들만의 공간이에요. 노트와 필기를 공유해보세요.
        </span>
      </div>
      {/* TODO(share): 공유 강의 게시판(채팅형 UI)은 share 담당이 구현 예정 */}
      <div className="text-label text-gray-650 rounded-xl border border-dashed border-gray-300 bg-gray-100 p-10 text-center">
